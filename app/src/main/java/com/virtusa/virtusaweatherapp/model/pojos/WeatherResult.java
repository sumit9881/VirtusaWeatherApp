...
public class WeatherResult implements Parcelable
{
    ...
    @Expose
    private Integer cod;
    public final static Creator<WeatherResult> CREATOR = new Creator<WeatherResult>() {
    ...
    protected WeatherResult(Parcel in) {
        ...
        in.readList(this.weather, (com.virtusa.virtusaweatherapp.model.pojos.Weather.class.getClassLoader()));
